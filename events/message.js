...
module.exports = message => {
  ...
  // prettier-ignore
  if (message.content.startsWith(`<@${config.botID}>`) || message.content.startsWith(`<@!${config.botID}>`)) message.channel.send(`${texts.MikuMentionedTexts(bot, message)} ${texts.MikuMentionedEmojis()}`);
